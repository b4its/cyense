...
export const api = {
  ...
  rules: () => req('/rules'),
  tools: () => req('/tools'),
  pentestOverview: () => req('/tools/pentest/overview'),
  pentestStages: () => req('/tools/pentest/stages'),
  profilePentest: (payload) => req('/tools/pentest/profile', { method: 'POST', body: JSON.stringify(payload) }),
  submitPentest: (payload) => req('/tools/pentest', { method: 'POST', body: JSON.stringify(payload) }),
  listScans: () => req('/scans'),
